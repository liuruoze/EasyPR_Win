...
#ifdef DLL_PLATEDETECT_EXPORTS
#define DLL_PLATEDETECT_API  __declspec(dllexport)
#else
#define DLL_PLATEDETECT_API  __declspec(dllimport)
...
class DLL_PLATEDETECT_API CPlateDetect
{
public:
	CPlateDetect();
